...
(function (O) {
  ...
  F.render = function () {
    ...
    if (F.state === 'unsupported') {
      root.append(el('p', { class: 'hint', text: 'Этот браузер не умеет сохранять в папку. Откройте программу в Chrome или Edge — тогда печати, подписи и готовые документы будут лежать в папке рядом с программой. Сейчас всё хранится в браузере, готовые файлы уходят в «Загрузки».' }));
